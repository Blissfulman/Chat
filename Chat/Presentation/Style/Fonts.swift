...
enum Fonts {
    ...
    static let buttonTitle = UIFont(name: "SF Pro Text Regular", size: 17)
    static let body = UIFont(name: "SF Pro Text Regular", size: 16)
    ...
    static let messageCellText = UIFont(name: "SF Pro Text Regular", size: 16)
    static let messageCellDate = UIFont(name: "SF Pro Text Regular", size: 11)
}
