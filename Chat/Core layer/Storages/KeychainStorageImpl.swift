...
final class KeychainStorageImpl: KeychainStorage {
    ...
    func fetchValue(withLabel label: String) -> String? {
        guard
            ...
            DebugLogger.log("Keychain data not found")
            return nil
        }
        return value
    }
    ...
    func saveValue(_ value: String, withLabel label: String) -> Bool {
        ...
        DebugLogger.log(status == noErr ? "Data saved to Keychain" : "Keychain saving error")
        return status == noErr
    }
    ...
    private func readValue(withLabel label: String) -> String? {
        ...
        guard
            ...
            DebugLogger.log("Unexpected Keychain data")
            return nil
        }
        return value
    }
